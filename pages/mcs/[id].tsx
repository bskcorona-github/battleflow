              ...
              {currentSession ? (
                <div className="mb-6">
                  ...
                  >
                    <textarea
                      name="content"
                      className="w-full p-3 border rounded-lg focus:ring-2 focus:ring-blue-500 text-gray-900 dark:text-gray-100 bg-white dark:bg-slate-700 border-gray-300 dark:border-gray-600 font-medium"
                      rows={3}
                      placeholder="コメントを入力..."
                      required
                    ></textarea>
